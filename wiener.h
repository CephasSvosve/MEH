...
//equivalent daily div growth
    ...
    double _g1 = pow((1+0.02),1./252)-1; //0.093472171
    double _g2 = pow((1+0.02),1./252)-1; //0.088976849
    double _g3 = pow((1+0.02),1./252)-1; //0.061685269
...
//sigma
    ...
    double annuity_factor_1 = (1-pow((1+_g1)/(1+day_cost_of_equity),252))/(day_cost_of_equity-_g1);
    double annuity_factor_2 = (1-pow((1+_g2)/(1+day_cost_of_equity),252))/(day_cost_of_equity-_g2);
    double annuity_factor_3 = (1-pow((1+_g3)/(1+day_cost_of_equity),252))/(day_cost_of_equity-_g3);


    //equivalent daily payment annuity factor
    double _a1 = ((1.093472171)/(1+day_cost_of_equity))/annuity_factor_1;
    double _a2 = ((1.088976849)/(1+day_cost_of_equity))/annuity_factor_2;
    double _a3 = ((1.061685269)/(1+day_cost_of_equity))/annuity_factor_3;


    vector<double> E_o = {10.23,9.16, 7.23}; //TODO add initial values for dividends and fcf
    vector<double> D_o = {1.68 * _a1,	1.79 * _a2,	2.26 * _a3};
